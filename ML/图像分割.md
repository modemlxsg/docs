...
![image-20200111060522655](J:\03_NOTES\ML\图像分割.assets\image-20200111060522655.png)



**4、图像识别、目标检测、语义分割、实例分割**

![image-20200110031703649](J:\03_NOTES\ML\图像分割.assets\image-20200110031703649.png)
...
![image-20200111062500842](J:\03_NOTES\ML\图像分割.assets\image-20200111062500842.png)



**UpSampling**

![image-20200111062513444](J:\03_NOTES\ML\图像分割.assets\image-20200111062513444.png)



**Deconvolution**

![image-20200111062543284](J:\03_NOTES\ML\图像分割.assets\image-20200111062543284.png)
...
![image-20200110030300693](J:\03_NOTES\ML\图像分割.assets\image-20200110030300693.png)

在上面的例子中，属于bed的像素被划分为“bed”类，与wall对应的像素被标记为“wall”等。

特别地，我们的目标是取一个大小为**WxHx3**的图像，并生成一个包含与所有像素对应的预测类ID的**WxH**矩阵。

![image-20200110030437474](J:\03_NOTES\ML\图像分割.assets\image-20200110030437474.png)
...
![image-20200110034647911](J:\03_NOTES\ML\图像分割.assets\image-20200110034647911.png)

![image-20200111032654911](J:\03_NOTES\ML\图像分割.assets\image-20200111032654911.png)
...
![image-20200111033111818](J:\03_NOTES\ML\图像分割.assets\image-20200111033111818.png)
...
![image-20200110034733206](J:\03_NOTES\ML\图像分割.assets\image-20200110034733206.png)

![image-20200111051814403](J:\03_NOTES\ML\图像分割.assets\image-20200111051814403.png)
...
![image-20200111043448431](J:\03_NOTES\ML\图像分割.assets\image-20200111043448431.png)
...
![image-20200111065527324](J:\03_NOTES\ML\图像分割.assets\image-20200111065527324.png)
...
![image-20200111065617581](J:\03_NOTES\ML\图像分割.assets\image-20200111065617581.png)
...
![image-20200110034914324](J:\03_NOTES\ML\图像分割.assets\image-20200110034914324.png)
